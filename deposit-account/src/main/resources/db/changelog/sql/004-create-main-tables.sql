...
-- ChangeSet Trung.Doan:4 labels:main-table runOnChange:true
...
CREATE TABLE IF NOT EXISTS tenant_0f522100_7d8c_4b67_9a7f_779e1b179eff.crypto_account
(
    id character varying(255) PRIMARY KEY,
    name character varying(255) NOT NULL,
    category_id character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS crypto_account_balance
(
    account_id character varying(255) NOT NULL,
    currency character varying(255) NOT NULL,
    account_type character varying(255) NOT NULL,
    amount double precision NOT NULL,
    CONSTRAINT crypto_account_balance_pk PRIMARY KEY(account_id, currency, account_type)
);
CREATE TABLE IF NOT EXISTS tenant_0f522100_7d8c_4b67_9a7f_779e1b179eff.crypto_account_balance
(
    account_id character varying(255) NOT NULL,
    currency character varying(255) NOT NULL,
    account_type character varying(255) NOT NULL,
...
(
    ...
    crypto_account_id character varying(255) NOT NULL,
    crypto_customer_type character varying(255) NOT NULL,
    crypto_customer_id bigint NOT NULL
);
CREATE TABLE IF NOT EXISTS tenant_0f522100_7d8c_4b67_9a7f_779e1b179eff.crypto_transaction
(
    id character varying(255) PRIMARY KEY,
    created_date timestamp with time zone,
    last_modified_date timestamp with time zone,
...
CREATE SEQUENCE IF NOT EXISTS crypto_account_id_seq INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1;
CREATE SEQUENCE IF NOT EXISTS tenant_0f522100_7d8c_4b67_9a7f_779e1b179eff.crypto_account_id_seq INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1;
