...
@EntityScan(basePackages = {"tech.corefinance.common.jpa.model", "tech.corefinance.customer.entity", "tech.corefinance.common.model", "tech.corefinance.common.entity_author"})
