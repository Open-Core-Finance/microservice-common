...
public class PaymentApplication {
    ...
    public static void main(String[] args) {
        String logFileNameDefault = "core_finance_payment";
        ...
        SpringApplicationBuilder app = new SpringApplicationBuilder(PaymentApplication.class);
        File file = new File(CommonConstants.LOGBACK_FILE_PATH_DEFAULT + "/" + logFileNameDefault + "_shutdown.pid");
        Logger log = LoggerFactory.getLogger(PaymentApplication.class);
